        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm">
            <div class="container">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                    <span class="menu-icon"><svg width="21" height="45" viewBox="0 0 21 45" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M37.5937 20.625H7.40625C6.42249 20.625 5.625 21.4225 5.625 22.4062V22.5938C5.625 23.5775 6.42249 24.375 7.40625 24.375H37.5937C38.5775 24.375 39.375 23.5775 39.375 22.5938V22.4062C39.375 21.4225 38.5775 20.625 37.5937 20.625Z" fill="white"/>
<path d="M37.5937 30H7.40625C6.42249 30 5.625 30.7975 5.625 31.7813V31.9687C5.625 32.9525 6.42249 33.75 7.40625 33.75H37.5937C38.5775 33.75 39.375 32.9525 39.375 31.9687V31.7813C39.375 30.7975 38.5775 30 37.5937 30Z" fill="white"/>
<path d="M37.5937 11.25H7.40625C6.42249 11.25 5.625 12.0475 5.625 13.0312V13.2188C5.625 14.2025 6.42249 15 7.40625 15H37.5937C38.5775 15 39.375 14.2025 39.375 13.2188V13.0312C39.375 12.0475 38.5775 11.25 37.5937 11.25Z" fill="white"/>
</svg>
</span>
                </button>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul style="display: flex; align-items: center" class="navbar-nav ms-auto">
                        ...
                        @if (Auth::check())
                        <li>
                            <a style="display: flex; flex-direction: column; color: white; align-items: center; text-decoration: none; margin-right: 0.5vw; margin-left: 0.5vw" href="{{route('eventRegistered')}}">
